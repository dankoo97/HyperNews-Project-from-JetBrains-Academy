...
NEWS_JSON_PATH = 'C:/Users/Daniel/PycharmProjects/HyperNews Portal/HyperNews Portal/task/news.json'  # You can choose any path you want
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates', 'C:/Users/Daniel/PycharmProjects/HyperNews Portal/HyperNews Portal/task/hypernews/news/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
